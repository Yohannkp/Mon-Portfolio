...
export const projects: Project[] = [
  {
    slug: "applyflow",
    name: "ApplyFlow",
    pitch: "Plateforme de productivité augmentant l'efficacité des chercheurs d'emploi de 40%.",
    ...
    stack: {
      frontend: ["React", "TypeScript", "Tailwind CSS", "React Query", "Framer Motion"],
      backend: ["Node.js", "Express", "PostgreSQL", "Prisma"],
      database: ["PostgreSQL", "Supabase"],
      tools: ["Docker", "CI/CD", "Jest"],
    },
    links: {
